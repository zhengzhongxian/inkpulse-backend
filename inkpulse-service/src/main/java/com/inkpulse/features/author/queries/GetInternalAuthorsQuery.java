...
@Setter
@NoArgsConstructor
public class GetInternalAuthorsQuery extends PagedRequest implements Query<PagedList<AuthorResponse>> {

    public GetInternalAuthorsQuery(String searchKeyword, int pageNumber, int pageSize) {
