...
VALUES
    (gen_random_uuid(), 'Xem danh sách banner nội bộ', 'banner:read', 'Banner', NOW(), NOW(), false, 0),
    (gen_random_uuid(), 'Tạo banner quảng cáo mới', 'banner:write', 'Banner', NOW(), NOW(), false, 0),
    (gen_random_uuid(), 'Xóa banner quảng cáo', 'banner:delete', 'Banner', NOW(), NOW(), false, 0)
